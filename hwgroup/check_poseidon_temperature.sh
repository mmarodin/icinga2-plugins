#!/bin/sh
#--------
# Check HWGroup Poseidon temperature status script for Icinga2
# Require: net-snmp-utils, bc
# v.20211206 by mmarodin
#
  ...
  while getopts ":V:H:C:w:c:h" optname ; do
    case "$optname" in
      ...
      "C")
        ...
        ;;
      "h")
        echo "Useage: check_poseidon_temperature.sh -H hostname -C community -V version"
        exit 2
        ;;
      "?")
